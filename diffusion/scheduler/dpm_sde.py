...
from diffusion.model.dpm_stochastic_solver import DPM_Stochastic_Solver, NoiseScheduleFlow, NoiseScheduleVP, model_wrapper
...
def DPMS_SDE(
    ...
    return DPM_Stochastic_Solver(model_fn, noise_schedule, algorithm_type="dpmsolver++")
